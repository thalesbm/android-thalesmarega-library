...
public class CustomJsonObjectRequest extends Request<JSONObject> {
    ...
    public CustomJsonObjectRequest(int method, String url, Response.Listener<JSONObject> response, Response.ErrorListener listener) {
        super(method, url, listener);
        this.mResponse = response;
    }

    public CustomJsonObjectRequest(int method, String url, String jsonRequest, Map<String, String> headers, Response.Listener<JSONObject> response, Response.ErrorListener errorListener) {
